...
import paddle
from fastdeploy.model_executor.ops.gpu import moe_wna16_marlin_gemm
...
def fused_marlin_moe(hidden_states: paddle.Tensor,
    ...
    - quant_type_str (str): the weights quantization used, the optional value is "uint4" or "uint4b8".
    ...
    """
    assert quant_type_str in ["uint4", "uint4b8"]
